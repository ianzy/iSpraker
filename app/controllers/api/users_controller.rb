class Api::UsersController < Api::BaseController
  ...
  def collection
    ...
    collection = super
    res = collection.where(:lat => lat_lhs_range..lat_rhs_range,
    ...
    res = collection.where(:id => 1..rand(50)).select("uid, screen_name, email, created_at, updated_at, lat, lng, profile_image_url, description, time_zone, real_name, position, company, phone_number") if res.nil? || res.empty?
    res
    # collection
  end
